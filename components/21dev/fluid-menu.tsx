    ...
    return (
        <div className="relative w-[48px]" data-expanded={isExpanded}>
            ...
            <div className="relative">
                ...
                <div
                    className="relative w-12 h-12 bg-gray-100 dark:bg-muted cursor-pointer rounded-full group will-change-transform z-50"
                ...
                {childrenArray.slice(1).map((child, index) => (
                    <div
                        key={index}
                        className="absolute top-0 left-0 w-12 h-12 bg-gray-100 dark:bg-muted will-change-transform"
                        style={{
