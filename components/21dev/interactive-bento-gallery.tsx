    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="fixed z-50 top-1/2 right-4 -translate-x-1/2 touch-none"
            >
                <motion.div
        ...
        <div className="px-4 py-8 ">
            ...
            <AnimatePresence mode="wait">
                {selectedItem ? (
                    ...
                    <motion.div
                        className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-3 auto-rows-[60px] md:auto-rows-[160px]"
                        initial="hidden"
                        animate="visible"
                        exit="hidden"
                        variants={{
                            ...
                            >
                                ...
                                >
                                    <div className="absolute inset-0 flex flex-col justify-end p-2 sm:p-3 md:p-4">
                                        ...
                                        <span className="relative text-white/70 text-[10px] sm:text-xs md:text-sm mt-0.5 line-clamp-2">
                                            {item.desc}
                                        </span>
                                    </div>
                                </motion.div>
