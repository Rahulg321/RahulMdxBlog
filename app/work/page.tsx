    ...
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        <p>
          ...
          way, teach the next generation of developers. Here&apos;s a summary of
          my work so far.
        </p>
        <h2 className="mb-1 tracking-tighter">Vercel</h2>
        ...
        <h2 className="mb-1 tracking-tighter">Hy-Vee</h2>
        <p className="text-neutral-600 dark:text-neutral-400 text-sm">
        ...
        <h2 className="mb-1 tracking-tighter">Workiva</h2>
        <p className="text-neutral-600 dark:text-neutral-400 text-sm">
